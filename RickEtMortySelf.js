...
bot.on('ready', () => {
  console.clear();
	console.log("[RickEtMortyr] Connecté à Discord via le token réussie !")
  console.log(`[RickEtMortyr] Username : ${bot.user.username}`)
  console.log(`[RickEtMortyr] ID : ${bot.user.id}`)
  console.log("[Avertissement] L'utilisation d'un selfbot est contre les TOS de Discord API")
  console.log("[Avertissement] Je ne suis pas responsable de vos actes")
  console.log("[Avertissement] Ne contacter pas Punchnox si vous avez des problèmes avec le selfbot")
...
bot.on('message', message => {
	...
	if (message.author === bot.user){
        ...
        if (message.content.startsWith(prefix + 'help')){
            ...
            .setFooter('Selfbot by 𝙥𝙪𝙣𝙘𝙝𝙣𝙤𝙭 | Refait par AntiD0xx', 'https://cdn.discordapp.com/attachments/627432311704649739/631924472915558401/BigAromaticEthiopianwolf-max-1mb.gif');
        ...
        if (message.content.startsWith(prefix + 'hack')){
            ...
            .setColor("#000000")
            .addField("/ddos [ip]", "DDOS une IP (Désactivé)")
            .addField("/iplog [lien]", "Envoie un IP logger cammouflé")
            .addField("/token [mention]", "trouve le token de la personne mentionnée (Désactivé)")
...
if (message.content.startsWith(prefix + 'user')){
            ...
            .setColor("#000000")
            .addField("stream [text]", "Te met en stream (Désactivé)")
            ...
            .addField("MultiStream", 'commande MultiStream (Désactivé)')
...
.setFooter('Selfbot made By 𝙥𝙪𝙣𝙘𝙝𝙣𝙤𝙭 | Refait par AntiD0xx', 'https://cdn.discordapp.com/attachments/627432311704649739/631924472915558401/BigAromaticEthiopianwolf-max-1mb.gif');
...
if (message.content === prefix + 'deletemoji') {
  ...
  if (message.content === prefix + 'deleterole') {
    ...
    message.channel.send("Tous les rôles ont été supprimés :white_check_mark:")
  }
...
if (message.content === prefix + 'allban') {
   ...
   message.channel.send("Ban all réussi :white_check_mark:")
	...
	if (message.content.startsWith(prefix + 'listen')){
             ...
             name: `${args.join(" ")}`,
             type: "LISTENING",
             //url: "https://www.twitch.tv/punchnox"
             }
             });
