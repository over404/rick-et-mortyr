...
if(message.content === prefix + "multistream"){
    ...
    setInterval(function() {
        if(rotate === 0) {
            client.user.setActivity("rick", {type: "Streaming", url: 'https://www.twitch.tv/punchnox'});
            rotate = 1;       
        } else if(rotate === 1){
            client.user.setActivity("et", {type: "Streaming", url: 'https://www.twitch.tv/punchnox'});
            rotate = 2;
        } else if(rotate === 2){
            client.user.setActivity(`morty`, {type: "Streaming", url: 'https://www.twitch.tv/punchnox'});
            rotate = 3;
        }  else if(rotate === 3){
            random = Math.floor(Math.random() * 7) + 1;
            client.user.setActivity(`selfbot 👁️`, {type: "Streaming", url: 'https://www.twitch.tv/punchnox'});
            rotate = 0;
        }}, 20 * 2000)
